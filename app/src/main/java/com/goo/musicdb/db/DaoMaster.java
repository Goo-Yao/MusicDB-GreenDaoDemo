...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        LikeMusicDao.createTable(db, ifNotExists);
        LikeSpecialDao.createTable(db, ifNotExists);
        MusicDao.createTable(db, ifNotExists);
        SingerDao.createTable(db, ifNotExists);
        SpecialDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        LikeMusicDao.dropTable(db, ifExists);
        LikeSpecialDao.dropTable(db, ifExists);
        MusicDao.dropTable(db, ifExists);
        SingerDao.dropTable(db, ifExists);
        SpecialDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(LikeMusicDao.class);
        registerDaoClass(LikeSpecialDao.class);
